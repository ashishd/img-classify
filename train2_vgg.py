...
# The smallvggnet model is a class function that applies the
# convolutional neural network for classifying
from imgclassify.smallvggnet import SmallVGGNet
...
# Using separate training and validation datasets
...
# vector) - for one-hot encoding of the labels
lb = LabelBinarizer()
