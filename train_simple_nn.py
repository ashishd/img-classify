...
ap.add_argument("-d", "--dataset", required=True,
	help="path to input training dataset of images")
...
for valImgPath in valImgPaths:
	...
	vimage = cv2.resize(vimage, (32, 32)).flatten()
	vdata.append(vimage)
...
#(testX, testY) = train_test_split(vdata,
#	vlabels, test_size=0.1, random_state=42)
trainX = data
trainY = labels
testX = vdata
testY = vlabels
